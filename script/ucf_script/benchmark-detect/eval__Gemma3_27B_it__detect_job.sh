...
#SBATCH --output=logs/gemma3-detect_%j.out
#SBATCH --error=logs/gemma3-detect_%j.err

# ============================================================
# Gemma-3-27B-it Detection Evaluation — UCF Newton
# ============================================================
...
$PYTHON -m pip install -r "${benchmark_dir}/requirements/requirements_eval_gemma3.txt" --no-deps
