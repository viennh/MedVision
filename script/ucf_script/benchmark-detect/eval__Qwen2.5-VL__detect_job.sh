#!/bin/bash
#SBATCH --job-name=qwen25vl-detect
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
#SBATCH --output=logs/qwen25vl-detect_%j.out
#SBATCH --error=logs/qwen25vl-detect_%j.err

# ============================================================
# Qwen2.5-VL Detection Evaluation — UCF Newton
# ============================================================
