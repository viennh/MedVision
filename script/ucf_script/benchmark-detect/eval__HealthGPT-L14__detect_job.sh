#!/bin/bash
#SBATCH --job-name=healthgpt-detect
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
#SBATCH --output=logs/healthgpt-detect_%j.out
#SBATCH --error=logs/healthgpt-detect_%j.err

# ============================================================
# HealthGPT-L14 Detection Evaluation — UCF Newton
# ============================================================
