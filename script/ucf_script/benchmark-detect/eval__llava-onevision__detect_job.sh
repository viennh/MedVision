#!/bin/bash
#SBATCH --job-name=llava-ov-detect
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
#SBATCH --output=logs/llava-ov-detect_%j.out
#SBATCH --error=logs/llava-ov-detect_%j.err

# ============================================================
# LLaVA-OneVision Detection Evaluation — UCF Newton
# ============================================================
