#!/bin/bash
#SBATCH --job-name=llama32v-detect
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
#SBATCH --output=logs/llama32v-detect_%j.out
#SBATCH --error=logs/llama32v-detect_%j.err

# ============================================================
# Llama-3.2-Vision Detection Evaluation — UCF Newton
# ============================================================
...
$PYTHON -m pip install -r "${benchmark_dir}/requirements/requirements_eval_llama3_vision.txt" --no-deps
