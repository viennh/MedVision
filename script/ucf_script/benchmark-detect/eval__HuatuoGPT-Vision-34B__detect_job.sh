#!/bin/bash
#SBATCH --job-name=huatuogpt-detect
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
#SBATCH --output=logs/huatuogpt-detect_%j.out
#SBATCH --error=logs/huatuogpt-detect_%j.err

# ============================================================
# HuatuoGPT-Vision-34B Detection Evaluation — UCF Newton
# ============================================================
