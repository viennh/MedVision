#!/bin/bash
#SBATCH --job-name=internvl3-detect
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
#SBATCH --output=logs/internvl3-detect_%j.out
#SBATCH --error=logs/internvl3-detect_%j.err

# ============================================================
# InternVL3-38B Detection Evaluation — UCF Newton
# ============================================================
...
$PYTHON -m pip install -r "${benchmark_dir}/requirements/requirements_eval_internvl3.txt" --no-deps
