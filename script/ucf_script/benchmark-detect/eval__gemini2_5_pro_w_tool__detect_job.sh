#!/bin/bash
#SBATCH --job-name=gemini-pro-wt-detect
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=4
#SBATCH --mem=32G
#SBATCH --time=24:00:00
#SBATCH --output=logs/gemini-pro-wt-detect_%j.out
#SBATCH --error=logs/gemini-pro-wt-detect_%j.err

# ============================================================
# Gemini 2.5 Pro w/ Tool — Detection Evaluation — UCF Newton
