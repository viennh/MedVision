#!/bin/bash
#SBATCH --job-name=qwen25vl-sft-TL
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
#SBATCH --output=logs/qwen25vl-sft-TL_%j.out
#SBATCH --error=logs/qwen25vl-sft-TL_%j.err

# ============================================================
# Qwen2.5-VL SFT TL Evaluation — UCF Newton
# ============================================================
...
model_hf_id="YongchengYAO/MedVision__SFT-m__qwen25vl-7b__TL"
model_name="Qwen2.5-VL-7B-SFT-TL"
